...
if __name__ == '__main__':
    dirTrain = "D:\\mywork\\KB2E-master\\data\\FB15k\\train.txt"
    tripleNumTrain, tripleListTrain = openD(dirTrain)
    dirTest = "D:\\mywork\\KB2E-master\\data\\FB15k\\test.txt"
    tripleNumTest, tripleListTest = openD(dirTest)
    dirEntityVector = "entityVector.txt"
    entityVectorList, entityList = loadData(dirEntityVector)
    dirRelationVector = "relationVector.txt"
    ...
    testHeadRaw.writeRank( "testHeadRaw" + ".txt")
    testHeadRaw.getRelationRank()
    print(testHeadRaw.getMeanRank())
    testHeadRaw.writeRank("testRelationRaw" + ".txt")
    ...
    testTailRaw.writeRank("testTailRaw" + ".txt")
    ...
    testHeadFit.writeRank( "testHeadFit" + ".txt")
    testHeadFit.getRelationRank()
    print(testHeadFit.getMeanRank())
    testHeadFit.writeRank( "testRelationFit" + ".txt")
    ...
    testTailFit.writeRank( "testTailFit" + ".txt")