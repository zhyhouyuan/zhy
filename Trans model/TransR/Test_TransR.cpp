...
public:
    ...
    void run()
    {
		...
		//	break;
                        if (testid%100==0){
                             cout<<testid<<endl;
                            cout<<"   left    :  "<<lsum/(testid+1)<<'\t'<<lp_n/(testid+1)<<endl;

                            cout<<"left_filter:  "<<lsum_filter/(testid+1)<<'\t'<<lp_n_filter/(testid+1)<<endl;
                            cout<<"    right  :  "<<rsum/(testid+1)<<'\t'<<rp_n/(testid+1)<<endl;
                            cout<<"right_filter: "<<rsum_filter/(testid+1)<<'\t'<<rp_n_filter/(testid+1)<<endl;
                        }


		}
        cout<<"   left    :  "<<lsum/fb_l.size()<<'\t'<<lp_n/fb_l.size()<<endl;

        cout<<"left_filter:  "<<lsum_filter/fb_l.size()<<'\t'<<lp_n_filter/fb_l.size()<<endl;
        cout<<"    right  :  "<<rsum/fb_r.size()<<'\t'<<rp_n/fb_r.size()<<endl;
        cout<<"right_filter: "<<rsum_filter/fb_r.size()<<'\t'<<rp_n_filter/fb_r.size()<<endl;
